...
$arComponentParameters = array(
    "GROUPS" => array(
        "SETTINGS" => array(
            "NAME" => GetMessage("PAV_COMP_GROUP_SETTINGS"),
            "SORT" => 10,
        ),
    ),
    "PARAMETERS" => array(
        "IBLOCK_TYPE" => Array(
            "PARENT" => "SETTINGS",
            "NAME" => GetMessage("PAV_COMP_SETTING_IBTYPES"),
            "TYPE" => "LIST",
            "VALUES" => $arTypesEx,
            "DEFAULT" => "-",
            "REFRESH" => "Y",
        ...
        "IBLOCK_ID" => Array(
            "PARENT" => "SETTINGS",
            "NAME" => GetMessage("PAV_COMP_SETTING_IBLIST"),
            "TYPE" => "LIST",
            "VALUES" => $arIBlocks,
            "DEFAULT" => "-",
            "REFRESH" => "Y",
        ...
        "CACHE_GROUPS" => array(
            ...
            "NAME" => GetMessage("PAV_COMP_CACHE_GROUPS"),
            "TYPE" => "CHECKBOX",
            "DEFAULT" => "Y",
        ),
    ),
